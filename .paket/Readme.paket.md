...
5.b PM> `.paket/paket.exe install --redirects` install packages and creates redirects.  
5.c PM> `.paket/paket.exe install -f --createnewbindingfiles` install packages and create app.configs with redirects.
