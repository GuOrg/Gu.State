        ...
        public class WithObservableCollectionProperty
        {
            ...
            public void AddDifferent()
            {
                ...
                using (var tracker = Track.IsDirty(x, y, ReferenceHandling.Structural))
                {
                    ...
                    Assert.AreEqual(true, tracker.IsDirty);
                    Assert.AreEqual("WithObservableCollectionProperties Complexes [0] Name x: a y: b Value x: 1 y: 2", tracker.Diff.ToString(string.Empty, " "));
                    expectedChanges.Add("Diff");
                    CollectionAssert.AreEqual(expectedChanges, changes);

                    x.Complexes[0].Name = "b";
                    Assert.AreEqual(true, tracker.IsDirty);
                    Assert.AreEqual("WithObservableCollectionProperties Complexes [0] Value x: 1 y: 2", tracker.Diff.ToString(string.Empty, " "));
                    expectedChanges.Add("Diff");
                    CollectionAssert.AreEqual(expectedChanges, changes);
            ...
            public void RemoveStillDirty()
            {
                ...
                using (var tracker = Track.IsDirty(x, y, ReferenceHandling.Structural))
                {
                    ...
                    x.Complexes.RemoveAt(1);
                    Assert.AreEqual(true, tracker.IsDirty);
                    Assert.AreEqual("WithObservableCollectionProperties Complexes [0] Name x: a y: c Value x: 1 y: 3", tracker.Diff.ToString(string.Empty, " "));
            ...
            public void MoveXThenY()
            {
                ...
                using (var tracker = Track.IsDirty(x, y, ReferenceHandling.Structural))
                {
                    ...
                    x.Complexes.Move(0, 1);
                    Assert.AreEqual(true, tracker.IsDirty);
                    Assert.AreEqual("WithObservableCollectionProperties Complexes [0] Name x: b y: a Value x: 2 y: 1 [1] Name x: a y: b Value x: 1 y: 2", tracker.Diff.ToString(string.Empty, " "));
                    expectedChanges.AddRange(new[] {  "Diff", "IsDirty" });
                    CollectionAssert.AreEqual(expectedChanges, changes);
