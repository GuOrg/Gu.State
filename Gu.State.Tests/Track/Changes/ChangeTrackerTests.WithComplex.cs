        ...
        public class WithComplex
        {
            ...
            public void Subscribes()
            {
                ...
                using (var tracker = Track.Changes(source, ReferenceHandling.Structural))
                {
                    ...
                    var rootChangeEventArgs = RootChangeEventArgs.Create(ChangeTrackerNode.GetOrCreate(source.Value, tracker.Settings, false).Value, new PropertyChangeEventArgs(source.Value.GetProperty(nameof(source.Value.Value))));
                    var expected = new[]
                                       {
